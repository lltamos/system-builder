...
<s:form action="login" method="POST" namespace="/employee">
...
<div class="footer">
    ...
    <p class="web"><a href="#"><img src="images/webLogo.jpg" alt="logo"></a><a href="#"><img src="<%=basePath%>/images/webLogo.jpg"
                                                                                             alt="logo"></a><a href="#"><img
            src="<%=basePath%>/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="<%=basePath%>/images/webLogo.jpg" alt="logo"></a></p>
</div>
</body>
</html>
